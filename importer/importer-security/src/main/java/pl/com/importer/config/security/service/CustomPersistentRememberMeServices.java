package pl.com.importer.config.security.service;
...
public class CustomPersistentRememberMeServices extends AbstractRememberMeServices {
    ...
    public CustomPersistentRememberMeServices(Environment env,
        ...
        super(env.getProperty("spring.security.rememberme.key"), userDetailsService);
    ...
    protected void onLoginSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        PersistentToken token = userRepository.findOneByLogin(login).map(u -> {
            PersistentToken tok = new PersistentToken();
            tok.setSeries(generateSeriesData());
            tok.setUser(u);
            tok.setTokenValue(generateTokenData());
            tok.setTokenDate(new LocalDate());
            tok.setIpAddress(request.getRemoteAddr());
            tok.setUserAgent(request.getHeader("User-Agent"));
            return tok;
